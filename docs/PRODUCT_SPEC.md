# Product Spec — Airdrop Sybil Inspector

## Problem

Airdrop teams and ecosystem foundations need fast, explainable decisions in anti-fraud intelligence workflows. Static dashboards are not enough; the product must show how agents reason, verify, and produce action plans.
...
- airdrop eligibility screening
- cluster appeal review
- campaign fraud audit
